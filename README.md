...
This is a collection of scripts that we use for LIVE feedback for On-The-Fly data collection with RELION (very useful to explore already processed datasets too!) and RELION metadata analysis. Enjoy!
